 ...
 * @param {string} bet_size
 * @param {number} max_iter
 * @param {number} target_exploitability
 * @returns {string}
 */
export function solve_spot(oop_range, ip_range, flop, turn, river, starting_pot, effective_stack, bet_size, max_iter, target_exploitability) {
    let deferred8_0;
    let deferred8_1;
    try {
        ...
        const ptr3 = passStringToWasm0(turn, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passStringToWasm0(river, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len4 = WASM_VECTOR_LEN;
        const ptr5 = passStringToWasm0(bet_size, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len5 = WASM_VECTOR_LEN;
        const ret = wasm.solve_spot(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, starting_pot, effective_stack, ptr5, len5, max_iter, target_exploitability);
        var ptr7 = ret[0];
        var len7 = ret[1];
        if (ret[3]) {
            ptr7 = 0; len7 = 0;
